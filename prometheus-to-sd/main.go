...
func main() {
	...
	for _, sourceConfig := range sourceConfigs {
		...
		go readAndPushDataToStackdriver(stackdriverService, gceConf, containerConfig, sourceConfig)
	}
...
func readAndPushDataToStackdriver(stackdriverService *v3.Service, gceConf *config.GceConfig, containerConfig *config.ContainerConfig, sourceConfig config.SourceConfig) {
