...
// Find into how many batches we should divide timeserieses. Each request send to the stackdriver can't contain
// more than maxTimeseriesesPerRequest timeserieses.
func numberOfBatches(numberOfTimeserieses int) int {
	return (numberOfTimeserieses-1)/maxTimeseriesesPerRequest + 1
}
