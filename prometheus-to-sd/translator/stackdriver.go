...
// CreateMetricDescriptor creates or updates MetricDescriptor base on the provided MetricFamily
func CreateMetricDescriptor(service *v3.Service, config *config.GceConfig, component string, family *dto.MetricFamily) {
	metricDescriptor := metricFamilyToMetricDescriptor(config, component, family)
