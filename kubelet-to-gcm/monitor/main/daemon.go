...
var (
	...
	ctrlPort    = pflag.Uint("controller-port", 10252, "The kube-controller's port.")
...
func main() {
	...
	log.Info("The kubelet source is initialized.")
	...
	log.Info("The kube-controller source is initialized.")
	...
	for {
		go monitor.Once(kubeletSrc, service, name)
		go monitor.Once(ctrlSrc, service, name)
