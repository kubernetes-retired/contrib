...
func TestResourceCompareSuccess(t *testing.T) {
...
func TestResourceCompareDifferentSizes(t *testing.T) {
	left := make(e2e.ResourceUsageSummary)
	left["90"] = []e2e.SingleContainerSummary{
		{Name: "heapster-v10-2r6la/heapster", Cpu: 0.266, Mem: 846700000},
		{Name: "kibana-logging-v1-041ex/kibana-logging", Cpu: 0.000, Mem: 61200000},
...
func TestResourceCompareFailure(t *testing.T) {
	left := make(e2e.ResourceUsageSummary)
	left["90"] = []e2e.SingleContainerSummary{
		{Name: "heapster-v10-2r6la/heapster", Cpu: 0.266, Mem: 846700000},
		{Name: "kibana-logging-v1-041ex/kibana-logging", Cpu: 0.000, Mem: 61200000},
	...
	expectedViolating := ViolatingResourceUsageData{
		"etcd": {
			percentile:   "90",
