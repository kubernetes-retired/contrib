...
func doGenCommitters(client *github_api.Client) {
	...
	c = append([]string{"# auto-generated by " + os.Args[0] + " -gen-committers; manual additions should go in the whitelist"}, c...)
	err = ioutil.WriteFile(*committers, []byte(strings.Join(c, "\n")), 0640)
	if err != nil {
