...
func (c *ClaMunger) Munge(obj *githubhelper.MungeObject) {
	...
	if status == contextSuccess {
		...
		obj.RemoveLabelIfPresent(cncfClaNoLabel)
		obj.AddLabelIfAbsent(cncfClaYesLabel)
		return
	}
	...
	obj.RemoveLabelIfPresent(cncfClaYesLabel)
	obj.AddLabelIfAbsent(cncfClaNoLabel)
}
