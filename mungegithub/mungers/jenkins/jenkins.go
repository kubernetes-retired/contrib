...
// JenkinsBuilder is a Builder backed by Jenkins
// As compared to JenkinsClient, it adds a binding to a particular Jenkins job.
...
// GetLastCompletedBuild gets the last completed build for the configured jenkins job
