...
do it anymore as there is almost no capacity left. It has to somewhere else, and it is not sure that
...
may still do it, because noone touched Y. So C can be deleted immediatelly afte A. And B not. 
