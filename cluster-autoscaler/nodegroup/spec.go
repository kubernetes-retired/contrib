...
// Parses a node group spec represented in the form of `<minSize>:<maxSize>:<name>` and produces a node group spec object
func SpecFromString(value string) (*Spec, error) {
...
// Produces an error if there's an invalid field in the node group spec
