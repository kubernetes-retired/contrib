...
- By default, cluster autoscaler will enable instance protection on all nodes. This is to ensure only nodes managed by cluster autoscaler can be terminated. You can disable instance protection with `--protect-nodes=false`.
