...
func NewBootstrapVzTemplate(path string) (*BootstrapVzTemplate, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("error parsing template %q: %v", path, err)
	}
	return &BootstrapVzTemplate{data: m, bytes: data}, nil
}
